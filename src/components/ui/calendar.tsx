  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "hidden", // Hide standard label when using dropdowns to prevent duplication
        ...
        head_cell: "text-muted-foreground rounded-md w-9 font-bold text-[10px] uppercase tracking-widest text-center",
        ...
        caption_dropdowns: "flex justify-center gap-2 items-center z-20 absolute inset-0",
        dropdown: "bg-transparent font-bold text-sm text-primary cursor-pointer hover:bg-primary/5 px-1 rounded transition-colors focus:outline-none appearance-none border-none outline-none",
