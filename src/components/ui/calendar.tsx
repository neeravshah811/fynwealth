  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        hidden: "invisible",
        caption_dropdowns: "flex justify-center gap-2 items-center absolute inset-0 pointer-events-none",
        dropdown: "bg-transparent font-bold text-xs text-primary cursor-pointer hover:bg-primary/5 px-2 py-1 rounded transition-colors focus:outline-none appearance-none border-none outline-none pointer-events-auto",
