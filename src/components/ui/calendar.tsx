  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-bold font-headline text-primary flex items-center gap-1",
        ...
        head_cell: "text-muted-foreground rounded-md w-9 font-bold text-[10px] uppercase tracking-wider text-center",
        ...
        dropdown: "bg-transparent font-bold text-sm text-primary cursor-pointer hover:bg-primary/5 px-1 rounded transition-colors focus:outline-none appearance-none border-none",
